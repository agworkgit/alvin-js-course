...
console.log("tomato" === "Tomato"); // false (letter case will be taken into consideration when comparing)
...
Pay attention to letter case, 'tomato' NOT EQUAL 'Tomato'
